            ...
            <h2 style="margin-bottom: 30px;">Sửa thông tin sản phẩm</h2>
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <input style="width: 1112px;" type="text" name="txtPrice" value="<?php echo $row['price']; ?>">
                        </td>
                    </tr>
                    <tr>
                        <td></td>
            ...
            <?php
                if(isset($_POST['btnEditCourse'])){
                   ...
                   // alert("1");có đang BỎ TRỐNG trường nào KO?
                    ...
                    $sql = "UPDATE tbl_course SET course_name ='$courseName', description = '$description', price ='$price'
                            WHERE id_course = '$id'";
